## RUBIKS2.py
## CONSIDERS THE CUBE TO BE 3X3X3 (-1) CONTAINER OF "Blocks", USES ARRAY SWAPPING
...
class Block:
    ...
    def __negate_and_swap(self, l_idx, r_idx):  # will negate the left index and swap it with right
        # uses the "no third variable" swap, looks a bit confusing at first tho
